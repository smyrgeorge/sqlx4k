...
import io.github.smyrgeorge.sqlx4k.processor.test.generated.UserContextRepositoryWithHooksImpl
import kotlinx.coroutines.test.runTest
import kotlin.test.BeforeTest
import kotlin.test.Test

/**
 * Comprehensive tests for ContextCrudRepository hooks functionality.
 *
 * These tests verify that all supported hooks work correctly with context receivers:
 ...
 */
class ContextCrudRepositoryHooksTests {

    private lateinit var mockExecutor: MockQueryExecutor
    private val repository = UserContextRepositoryWithHooksImpl
    ...
    @Test
    fun `hooks work correctly with context receiver pattern`() = runTest {
        mockExecutor.setFetchAllRows(row("id" to "1"))
