...
class NativePostgreSQLInstantTests {
    ...
    private val runner = CommonPostgreSQLInstantTests(db)
    ...
    @Test
    fun `instant insert and select roundtrip`() = runner.`instant insert and select roundtrip`()
