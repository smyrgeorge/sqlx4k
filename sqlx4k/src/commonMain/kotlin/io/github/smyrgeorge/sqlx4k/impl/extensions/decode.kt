...
fun ResultSet.Row.Column.asUInt(): UInt = asString().toUInt()
fun ResultSet.Row.Column.asUIntOrNull(): UInt? = asStringOrNull()?.toUInt()
fun ResultSet.Row.Column.asLong(): Long = asString().toLong()
fun ResultSet.Row.Column.asLongOrNull(): Long? = asStringOrNull()?.toLong()
fun ResultSet.Row.Column.asULong(): ULong = asString().toULong()
fun ResultSet.Row.Column.asULongOrNull(): ULong? = asStringOrNull()?.toULong()
...
fun ResultSet.Row.Column.asUShort(): UShort = asString().toUShort()
fun ResultSet.Row.Column.asUShortOrNull(): UShort? = asStringOrNull()?.toUShort()
