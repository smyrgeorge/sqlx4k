...
@Config(sdk = [34])
class AndroidSQLiteCipherByteArrayTests {
    ...
    init {
        ...
        val dbFile = File(context.cacheDir, "sqlx4k-bytearray-tests.db").apply {
            if (exists()) delete()
        }
        db = sqliteCipher(
            context = context,
    ...
    private val runner = CommonSQLiteCipherByteArrayTests(db)
